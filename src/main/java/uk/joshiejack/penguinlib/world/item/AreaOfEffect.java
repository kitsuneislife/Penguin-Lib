...
//    public boolean onBlockDestroyed(@Nonnull ItemStack stack, Level world, BlockPos position, Player player) {
...
//    public ImmutableList<BlockPos> getPositions(Player player, Level world, BlockPos pos) {
